...
//////////////////////////////////////////
// Доработано для работы в мобильном приложении.
// В основном убраны отсутствующие объекты и методы
//
// Никита Грызлов
// e-mail: nixel2007@gmail.com
// Лето 2014
...
//
Функция myReadJSON(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
	
	Возврат jsonПрочитатьИнициализация(Значение, Стандарт, ПредставленияСсылок);
	
КонецФункции // myReadJSON()
...
//
Функция myWriteJSON(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
	
	Возврат jsonЗаписатьИнициализация(Значение, Стандарт, ПредставленияСсылок);
	
КонецФункции // myWriteJSON()
...
#Если ВебКлиент Или ТонкийКлиент Или МобильноеПриложениеКлиент Тогда
	ВызватьИсключение ИсключениеНевозможноПреобразоватьЗначениеНаКлиенте(Индекс, Значение);
// Грызлов Н.,  07.06.2014 +
// В мобильном приложении нигде нет доступа к
